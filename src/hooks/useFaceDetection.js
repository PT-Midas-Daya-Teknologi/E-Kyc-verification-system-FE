...
/** Supports raw video refs or react-webcam class instances exposing `.video`. */
...
/**
 * Runs MediaPipe Face Mesh on the webcam <video> element.
 * Streams high-frequency analytics through `onDetect` to avoid stale refs during UX gates.
 */
